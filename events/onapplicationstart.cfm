...
<cfscript>
	...
	//APPLICATION.spokeSearch = ['A','List','Of','Spoke','Models']; this will be the order you see on the search plugin. see the spokeInit argument searchProperties for more settings.
