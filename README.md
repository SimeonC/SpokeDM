...
Included in this repository is all the files needed to run SpokeDM, this includes a copy of CFWheels (<http://cfwheels.org>) and the DBMigrate plugin, both of which include their own licenses.
...
-  	This will list an (optionally filtered) set of objects that are instantiated on the model

`<cfwheels base url>/spokes/[modelname]/[key]`
	
-   This will load the instance of the model for editing/viewing.
